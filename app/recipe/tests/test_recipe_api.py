...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_create_basic_recipe(self):
        ...
        for key in payload.keys():
            # getattr is a helper function that allows to retrieve an attr
            # from an object by passing in a variable
    ...
    # test update with PATCH and PUT, which are provided by ModelViewSet
